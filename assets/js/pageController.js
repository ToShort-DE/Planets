...
function updatePage() {
    hideSections();
    $(document.getElementById(getPage())).fadeIn(500);
}

function setPage(page) {
    HashParameters.setParameter('page', page);
    updatePage();
}

function initNavigator() {
    HashParameters.addListener(updatePage);
    updatePage();
}
...
var lastHover = null;
function clickOnPlanet(element, page) {
